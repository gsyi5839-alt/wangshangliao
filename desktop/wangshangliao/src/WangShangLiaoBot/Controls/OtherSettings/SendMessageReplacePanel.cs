...
namespace WangShangLiaoBot.Controls.OtherSettings
{
    ...
    /// 发送消息替换 - 设置面板
    /// </summary>
    public sealed class SendMessageReplacePanel : UserControl
    {
        ...
        public SendMessageReplacePanel()
        {
        ...
        private void LoadData()
        {
            ...
            var data = SendMessageReplaceService.Instance.GetAll();
        ...
        private void BtnAddUpdate_Click(object sender, EventArgs e)
        {
            ...
            SendMessageReplaceService.Instance.AddOrUpdate(keyword, replacement);
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SendMessageReplaceService.Instance.Remove(keyword))
                {
